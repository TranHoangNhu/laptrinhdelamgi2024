    ...
    return (
		...
		<div className="container">
			...
			<div className="row">
				...
				<ProjectCardStyle1
					img="/assets/images/resource/pr1.webp"
					subTitle="Campaign"
					title="SEO Consulting"
				></ProjectCardStyle1>

				<ProjectCardStyle2
					img="/assets/images/resource/pr2.webp"
					subTitle="Campaign"
					title="SEO Consulting"
				></ProjectCardStyle2>

				<ProjectCardStyle2
					img="/assets/images/resource/pr3.webp"
					subTitle="Campaign"
					title="SEO Consulting"
				></ProjectCardStyle2>

				<ProjectCardStyle2
					img="/assets/images/resource/pr4.webp"
					subTitle="Campaign"
					title="SEO Consulting"
				></ProjectCardStyle2>
				...
				<div className="col-lg-4 col-md-6">
					<div className="single-project-box style-two">
						<div className="project-thumb">
							<Image src="/assets/images/resource/pr5.webp" alt="img" width={416} height={426}   />
							<div className="project-button">
								<div className="icon">
									<Image src="/assets/images/resource/project-icon.webp" alt="img" width={82} height={49}   />
								</div>
